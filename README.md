...
После этого в корне появится папка build

Чтобы собрать пакет в .tgz формат:

```bash
npm pack
```

После этого можно устанавливать пакет в проекты, с указанием пути до него:

```bash
npm install ./ui-kit-cybersec-0.1.3.tgz
```
